...
// 从kafka读取数据
    ...
    properties.setProperty("bootstrap.servers", "192.168.5.21:9092,192.168.5.22:9092,192.168.5.23:9092")
    ...
    val inputStream = env.addSource( new FlinkKafkaConsumer011[String]("mswtest", new SimpleStringSchema(), properties) )
